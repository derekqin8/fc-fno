...
x_train = np.load("darcy_r421_Lshape/piececonst_r421_N1024_coeff1.npy")
x_test = np.load("darcy_r421_Lshape/piececonst_r421_N1024_coeff2.npy")

y_train = np.load("darcy_r421_Lshape/piececonst_r421_N1024_L1.npy")
y_test = np.load("darcy_r421_Lshape/piececonst_r421_N1024_L2.npy")
...
x_train = torch.tensor(x_train)[:ntrain,::r,::r]
x_test = torch.tensor(x_test)[:ntest,::r,::r]

y_train = torch.tensor(y_train)[:ntrain,::r,::r]
y_test = torch.tensor(y_test)[:ntest,::r,::r]
...
train_loader = torch.utils.data.DataLoader(
        torch.utils.data.TensorDataset(x_train_grids, y_train),
        batch_size = batch_size,
        shuffle = True
        )

test_loader = torch.utils.data.DataLoader(
        torch.utils.data.TensorDataset(x_test_grids, y_test),
        batch_size = batch_size,
        shuffle = False
        )
...
np.save('results/darcy_Lshape_train_loss'+"_"+str(grid_loss), train_loss_total)
np.save('results/darcy_Lshape_test_loss'+"_"+str(grid_loss), test_loss_total)
